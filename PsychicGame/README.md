# PsychicGame
This is a simple letter press guessing game. Mostly taken from class work we had done previously mainly the Rock, Paper, Scissors game.
Added console logs in order to debug.
